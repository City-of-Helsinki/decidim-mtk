...
import appUrl from "../support/app_url";
...
export class AddCommentForm extends React.Component<AddCommentFormProps, AddCommentFormState> {
  public static defaultProps = {
    showTitle: true,
    submitButtonClassName: "button large secondary hollow",
    arguable: false,
    autoFocus: false,
    rows: 10
  };
      ...
      return (
        <p>
          <Translate
            ...
            sign_in_url={appUrl("/users/sign_in")}
            sign_up_url={appUrl("/users/sign_up")}
            dangerousHTML={true}
          />
        </p>
      );
  ...
  private _renderTextArea() {
    const { rows, commentable: { id, type }, autoFocus } = this.props;
