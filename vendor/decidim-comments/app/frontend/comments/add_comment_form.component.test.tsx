...
describe("<AddCommentForm />", () => {
  ...
  it("should have a default prop submitButtonClassName as 'button large secondary hollow'", () => {
    const wrapper = mount(<AddCommentForm addComment={addCommentStub} session={session} commentable={commentable} rootCommentable={commentable} orderBy={orderBy} />);
    expect(wrapper.props()).toHaveProperty("submitButtonClassName", "button large secondary hollow");
  });
