...
describe("<Comment />", () => {
  ...
  it("should render a AddCommentForm component for a root comment with the correct props when clicking the reply button", () => {
    const wrapper = shallow(
      <Comment
        comment={comment}
        session={session}
  ...
  it("should not render a AddCommentForm component for a non-root comment with the correct props when clicking the reply button", () => {
    const wrapper = shallow(
      <Comment
        comment={comment}
        session={session}
